...
BEGIN
	...
	BEGIN
		...
		SET @w_banco_char = '0' + convert(CHAR(3), @w_banco_pago)
	...
	BEGIN TRY
		...
		--Indica que paso por Sybase y guardo en re_pago_movll
		SET @w_sybase = 'S'
	...
	BEGIN CATCH
		...
		--Indica que paso por Sybase y debio guardo en re_pago_movll
		SET @w_sybase = 'S'
...
SALIR:
	BEGIN TRY	
		...
		IF ISNULL(@w_num_error,0) != 0 AND ISNULL(@w_retorno,'') = '00'
		BEGIN
			SET @o_retorno = '12'
			SET @o_mensaje = 'TRANSACCION FALLIDA'
		END
